			...
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<select name="ada_pilihan" class="form-control" required>
						...
						<option value="1">Pilihan Sub Kriteria profesional</option>
						<option value="2">Pilihan Sub Kriteria pelayanan</option>
						<option value="3">Pilihan Sub Kriteria kecekatan</option>
					</select>
				</div>
			</div>
		</div>
