...
<head>
  ...
  <link rel="shortcut icon" href="assets/img/kominfo.png" type="image/x-icon">
  <link rel="icon" href="assets/kominfo.png" type="image/x-icon">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <img src="<?=('assets/')?>img/kominfo.png"  style="width:50px;" alt="">
        </div>
	...
	<!--  <li class="nav-item <?php if($page == "Sub Kriteria"){echo "active";} ?>">
	  ...
	  <!--<li class="nav-item <?php if($page == "Alternatif"){echo "active";} ?>">
        <a class="nav-link" href="tambah-alternatif.php">
          <i class="fas fa-fw fa-users"></i>
    ...
    <li class="nav-item <?php if($page == "Penilaian"){echo "active";} ?>">
	  ...
	  <li class="nav-item <?php if($page == "Hasilpegawai"){echo "active";} ?>">
        <a class="nav-link" href="hasilpegawai.php">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Data Hasil Akhir</span></a>
      </li>	
