...
<html lang="en">
    ...
    <body class="bg-gradient-info">
        ...
        <div class="container">
				...
				<div class="col-xl-5 col-lg-5 col-md-5 mt-5 mx-auto" >
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-body p-0">
                            ...
                            switch($status):
                                case 'sukses-baru':
                                    $msg = 'Anda berhasil Register! Silahkan Login';
                                    break;
                                // case 'sukses-hapus':
                            ...
                            ?>
                                            <h1 class="h3 text-gray-900 mb-4">Login Account</h1>
                                        </div>
										<?php if(!empty($errors)): ?>
                                        ...
                                        <form class="user" action="login.php" method="post">
                                            ...
                                            <div class="button">
                                                <a href="daftar.php" role="button" class="fa fa-user mt-2" aria-hidden="true"> Silahkan Mendaftar terlebih Dahulu!</a>
                                            </div>
