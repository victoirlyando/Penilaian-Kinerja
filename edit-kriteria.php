			...
			<div class="row">
				...
				<div class="form-group col-md-6">
					...
					<select name="ada_pilihan" class="form-control" required>
						...
						<option value="1" <?php if($d['ada_pilihan']=="1") {echo "selected";} ?>>Pilihan Sub Kriteria profesional</option>						
						<option value="2" <?php if($d['ada_pilihan']=="2") {echo "selected";} ?>>Pilihan Sub Kriteria palayanan</option>						
						<option value="3" <?php if($d['ada_pilihan']=="3") {echo "selected";} ?>>Pilihan Sub Kriteria kecekatan</option>						
					</select>
				</div>
			</div>
		</div>
